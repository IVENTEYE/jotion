      ...
      <DropdownMenuTrigger asChild>
        <div role="button" className="flex items-center text-sm p-3 w-full hover:bg-primary/5">
          <div className="gap-x-2 flex items-center max-w-[150px]">
            ...
            <span className="text-start font-medium line-clamp-1">{user?.fullName} Jotion</span>
          </div>
          <ChevronsLeftRight className="rotate-90 ml-2 translate-x-[10px] text-muted-foreground h-4 w-4" />
        </div>
      </DropdownMenuTrigger>
